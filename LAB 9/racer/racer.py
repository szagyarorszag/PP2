...
f1 = pg.font.Font(r'racer\assets\Minecraft.ttf', 20)
f2 = pg.font.Font(r'racer\assets\Minecraft.ttf', 25)

screen=pg.display.set_mode((SCR_W, SCR_H))
pg.display.set_caption("capybara racer")

icon=pg.image.load(r"racer\assets\iconn.png")
icon2=pg.image.load(r"racer\assets\iconn2.png")

pg.display.set_icon(icon)
mix.music.load(r"racer\assets\themesong.mp3")
mix.music.set_volume(0.2)
mix.music.play(-1)

bg=pg.image.load(r"racer\assets\background.png")
bg1=pg.image.load(r"racer\assets\backgrounddead.png")
...
class Enemy(pg.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pg.image.load(r"racer\assets\enemy1.png")
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pg.image.load(r"racer\assets\capidef.png")
        self.imagecool=pg.image.load(r"racer\assets\capihapi.png")
        self.imagefail=pg.image.load(r"racer\assets\capidead.png")
        self.rect = self.image.get_rect()
...
class Coins(pg.sprite.Sprite):
    def __init__(self):
        ...
        if self.mode==0:
            self.image=pg.image.load(r"racer\assets\banana.png")
        else:
            self.image = pg.image.load(r"racer\assets\orange.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pg.sprite.spritecollideany(CAPY, enemies):
          pg.display.update()
          mix.music.stop()
          mix.music.load(r"racer\assets\deadfile.mp3")
